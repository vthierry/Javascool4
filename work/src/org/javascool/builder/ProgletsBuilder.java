...
public class ProgletsBuilder {
  ...
  private static void javac(String classPath, String[] javaFiles) {
    ...
    try {
      ...
      if(sout.length() > 0) {
        System.out.println("Erreur de compilation java:\n" + sout); throw new IllegalArgumentException("Erreur de compilation java");
      }
    } catch(Throwable e) {
      System.err.println("Echec de compilation :" + e); throw new IllegalArgumentException("Erreur de compilation java");
    }
  }
