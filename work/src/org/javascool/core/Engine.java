...
public class Engine {
  ...
  public void doCompile() { throw new RuntimeException("Non implémenté");
  }
  /** Mécanisme de lancement du programme compilé. */
  public void doRun() { throw new RuntimeException("Non implémenté");
  }
   ...
   */
  public Proglet setProglet(String proglet) { throw new RuntimeException("Non implémenté");
  }
  /** Renvoie la proglet en cours de fonction.
   * @return La proglet en fonctionnement.
   */
  public Proglet getProglet() { throw new RuntimeException("Non implémenté");
  }
}
