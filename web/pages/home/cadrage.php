...
<p>Il faut être clair&nbsp;: à l'ère numérique dans laquelle nous vivons, les fondements de l'informatique constituent un savoir indispensable comme peut l'être la lecture ou l'écriture, et tôt ou tard (et plutôt <i> <?php showLink('?page=home&action=manifest','tantôt que trop tard','internal');?></i>&nbsp;!), c'est une discipline à part entière qu'il faut pouvoir enseigner à nos jeunes, probablement en trois étapes&nbsp;:
</p>
...
<p>On peut dire, comme l'enseigne <?php showLink('http://www.lix.polytechnique.fr/%7Edowek','Gilles Dowek','external');?>, que, au confluent des quatre clés de voûte de l'informatique (Algorithme, Langage, Information, Machine), il y a la programmation. Apprendre à programmer permet de devenir autonome et de découvrir expérimentalement les fondements des sciences de l'information de ce 3ème millénaire. 
...
</p><p>Une <?php showLink('rtsp://stream-serv.inrialpes.fr/Roc/SeminaireInformatiqueObjetsNumeriques/T_Vieville.rm','présentation vidéo','file');?> accompagnée de ses <?php showLink('http://www.loria.fr/%7Evthierry/cours/slides-ue-stflour.pdf','supports','external');?> complète cette petite analyse.
...
<p>Référence: <?php showLink('http://www.eduscol.education.fr/cid45768/programmes%A0en-vigueur.html','programmes en vigueur','external');?>
</p>
...
</p><p>Cet enseignement fait suite aux <?php showLink('http://www.education.gouv.fr/bo/2000/hs6/info.htm','options MPS','external');?> option transdisciplinaire  de sciences expérimentales.
</p>
...
<p>Comme <?php showLink('http://www.epi.asso.fr/revue/articles/a0912a.htm','détaillé ici','external');?> ces éléments sont clairement les 1ères étapes vers l'introduction progressive, massive et pérenne des sciences informatiques dans l'enseignement secondaire.
</p>
...
</p><p>Pour ce qui est de la rigueur, les lycéennees qui ont déjà profité de cet apprentissage, ont permis de vérifier cette règle attendue, à savoir que la rigueur se conjugue bien souvent au féminin. L'idée que <?php showLink('http://interstices.info/idee-recue-informatique-5','l\'informatique ne serait pas pour les filles','external');?> ne les a jamais effleurée, qu'elle ne nous effleure pas non plus.
...
<!-- Saved in parser cache with key wiki_sciencinfolycee:pcache:idhash:93-1!1!0!!fr!2!printable=1 and timestamp 20110721123140 -->
