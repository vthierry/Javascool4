...
<h2> <span class="mw-headline" id="Bienvenue_dans_l.27.C3.A8re_num.C3.A9rique"> Bienvenue dans l'ère numérique </span></h2>
<h3> <span class="mw-headline" id="Tout_a_un_reflet_num.C3.A9rique"> Tout a un reflet numérique</span></h3>
<p>Des chiffres ou des lettres, des nombres ou des mots, des dessins ou des images, des sons ou de la musique, des textes, des tableaux, des calculs, des films, des jeux,... toutes les informations humaines semblent pouvoir être entrées dans une machine électronique spécialisée (machine à calculer programmable, téléphone portable multi-fonction, console de jeux, et même ... carte bancaire, automates de machine à laver, circuits électroniques automobiles,...) ou une machine électronique "générale" que l'on nomme ordinateur.  Et que nous connaissons tous&nbsp;!
</p>
<h3> <span class="mw-headline" id="Et_le_calcul_est_un_processus_universel"> Et le calcul est un processus universel</span></h3>
<p>Mieux encore&nbsp;: ces machines électroniques générales sont en mesure de réaliser tout ce qui est mécanique&nbsp;: calculer, communiquer, mémoriser, interagir, simuler ... c'est à dire traiter ces informations, leur appliquer des mécanismes automatiques ou interactifs pour nous permettre de manipuler ces informations comme nous le souhaitons. Et ça aussi nous le savons tous&nbsp;!
</p>
<center><b>Mais comment cela marche t'il&nbsp;? Comment maîtriser tout cela&nbsp;?</b> </center>
<p><br />
Nous aidons à découvrir deux volets de cet indispensable savoir <a href="http://javascool.gforge.inria.fr" class="external text" rel="nofollow">ici</a>: algorithmes + objets numériques.
</p>
...
<!-- Saved in parser cache with key wiki_sciencinfolycee:pcache:idhash:91-1!1!0!!fr!2!edit=0!printable=1 and timestamp 20110721112910 -->
