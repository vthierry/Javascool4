...
public class Jvs2Java {
    ...
    public static String translate(String jvsCode) {
      ...
      /* //TODO      if (JVSMainPanel.getCurrentProglet().getJvsFunctionsToInclude()) {
   ...
   //TODO         head.append(JVSMainPanel.getCurrentProglet().getJavaCodeToIncludeBefore());
    ...
    //TODO        head.append(JVSMainPanel.getCurrentProglet().getJavaCodeToIncludeAfter());
