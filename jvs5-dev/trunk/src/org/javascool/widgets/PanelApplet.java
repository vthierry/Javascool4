...
public class PanelApplet extends JApplet {
   ...
   * @param manualStart Invocations manuelles si true des méthodes
...
*/
  ...
  @Override
  public void init() {
    if (PanelApplet.pane != null) throw new IllegalStateException("Impossible d'instancier deux PanelApplet dans une application");
    try {
      if (panel == null) {
