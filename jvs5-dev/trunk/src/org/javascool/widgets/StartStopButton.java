...
*/
  private void doStart() {
    ...
    revalidate();
    /*
     * BUG FIX : Stop button not change immediately at program stop. SOLUTION :
     * Use two separate Threads to check running speeder than the Timer which
     * get up all seconds, the isRunningThread get up all 50 milliseconds.
...
*/
  ...
  /** Cette méthode est appellée par le compteur pour déterminer si le programme
   * est terminé.
   * <p>
