...
public class Exec {
   ...
   * @param timeout Temporisation maximale avant la fin de la commande. Valeur
   *        par défaut 10.
   *        <p>
   *        Si 0, l'attente est indéfinie.
   *        </p>
   *        <p>
   *        Si -1, la commande est lancée en arrière plan et la fonction revient
   *        tout de suite, sans résultat.
   *        </p>
