...
*/
  public static void save(String location, String string, boolean backup, boolean utf8) {
    ...
    try {
      ...
      OutputStreamWriter writer = location.startsWith("file:") ? FileManager.getFileWriter(location.substring(5), backup, utf8) : FileManager.getUrlWriter(location, utf8);
...
*/
  private static OutputStreamWriter getUrlWriter(String location, boolean utf8) throws IOException {
    ...
    OutputStreamWriter writer = new OutputStreamWriter(connection.getOutputStream(), utf8 ? Charset.forName("utf-8") : Charset.defaultCharset());
...
*/
   ...
   * @return Une énumération des fichiers listés: le path canonique est renvoyé.
...
*/
   ...
   * 
   * @param rep Le répertoir dans lequel se placer, laisser à null si le système
   *        doit choisir
...
*/
   ...
   * sauvegarder un fichier. Actuellement AWT sous Mac et SWING sous les autres.
   * 
   * @param saveAs Un drapeau pour déterminer si c'est Enregistrer (false) ou
