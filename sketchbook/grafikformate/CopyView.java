...
public class CopyView extends Canvas{
	...
	public void scaleImage(int width, int height){
		...
		try { MT.waitForID(0); }
		catch(InterruptedException e) {System.out.println("MT exception");}
		outImage = tmp;
	}
	...
	public void changeColor(boolean scaled){
		...
		catch(InterruptedException e) {System.out.println("grabber exception");}
		if (colorDepth == 0){
