...
public class ImageChanger extends Applet implements ItemListener{//, ActionListener{//, MouseListener{
	...
	public void init(){
		...
		c.anchor=GridBagConstraints.CENTER;
		c.gridx = 1; c.gridy=0; c.gridwidth=2;c.gridheight=5;c.weightx=c.weighty=0;
		topPanel.add(imageView,c);
		c.gridx = 3; c.gridy=0; c.gridwidth=3;c.gridheight=5;c.weightx=c.weighty=1;
		topPanel.add(infoView,c);

		c.gridx = 0; c.gridy=5; c.gridwidth=3;c.gridheight=1;c.weightx=c.weighty=0;
		...
		cMain.gridx = 0; cMain.gridy=0; cMain.gridwidth=1;cMain.gridheight=1;cMain.weightx=cMain.weighty=0;
		this.add(topPanel,cMain);
		cMain.gridy=1;
		this.add(imagePanel[0],cMain);
		cMain.gridy=2;
		this.add(imagePanel[1],cMain);
		cMain.gridy=3;cMain.anchor=GridBagConstraints.CENTER;
		cMain.fill = GridBagConstraints.BOTH;
