...
// ======================================================== 
  ...
  */
  ...
  if ((scenario<1) ||(scenario>11)) throw new RuntimeException("Fct [createRandomShape] : scenario incorrect");  
    ...
    switch (scenario) {
      case 1 : xxRandomSquareDrawing();
               break;
               
      case 2 : xxRandomCircleDrawing();
               break;
               
      case 3 : xxRandomShapeDrawing();
               break;
               
      case 4 : xxRandomSquareDrawing();
               xxRandomRotate();
               break;
      ...
      case 6 : xxRandomCircleDrawing();
               xxRandomNoiseLight();
               break;
               
      case 7 : xxRandomShapeDrawing();
               xxRandomRotate();
               break;
      ...
      case 9 : xxRandomSquareDrawing();
               xxRandomRotate();
               xxRandomNoiseStrong();
               break;  
               
      case 10 : xxRandomCircleDrawing();
               xxRandomNoiseStrong();
               break;  
               
      case 11 : xxRandomShapeDrawing();
               xxRandomRotate();
               xxRandomNoiseStrong();
               break;                                                                                         
