...
public class Argument extends InfoTypee {	
	...
	public final String getDim(int dim) {
		...
		if (dim==1) {
			...
			Argument arg = new Argument(this.nom, this.type, mode.substring(i+1));
	...
	public final void ecrireSql(Programme prog, StringBuffer bufInto, StringBuffer bufVal, StringBuffer bufPrep) {
		if ( isSimple() ) {
	...
	private void ecrireSimpleSql(Programme prog, StringBuffer bufInto, StringBuffer bufVal, StringBuffer bufPrep) {
	...
	private void ecrireEnregistrementSql(Programme prog, StringBuffer bufInto, StringBuffer bufVal, StringBuffer bufPrep) {
