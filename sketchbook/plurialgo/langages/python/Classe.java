...
//		Divers.ecrire(buf, prog.quote("definition de la classe"), indent+1);
//		if ((proprietes.size()>0))
//			prog.commenter(buf, "proprietes (implicites)", indent+1);
//		for (Iterator iter=proprietes.iterator(); iter.hasNext();) {
